      ...
      <mt-tab-container-item id="1">
            ...
            <a class="mint-cell mint-field">
              ...
              <div class="mint-cell-wrapper">
                ...
                <div class="mint-cell-value">
                  <input type="radio" id="radio-1-1" name="radio-1-set" class="regular-radio big-radio" value="企业"
                         checked v-model="invoiceForm.type" @click="SaveType('企业')"/>
        ...
        <div class="invoice-contents">
          ...
          <div class="invoice-category">
            <div>
              <span>发票类别</span>
              <select name="" id="" @change="selectCustomCategoryId()" v-model="customCategory">
                <option :value="categoryName[index].invoiceCustomCategoryId" v-for="(items,index) in categoryName"
                        :key="index" v-text="items.name"></option>
              </select>
            </div>
            <div>
              <span>开票金额</span>
              <input type="number" placeholder="请输入开票金额" v-model="price" style="color:#e4393c;">元
            </div>
          </div>
          <a class="mint-cell mint-field"><!---->
            <div class="mint-cell-left"></div>
...
<style scoped>
  ...
  .invoice-category > div > select, .invoice-category > div > input {
    margin-left: 30px;
    width: 150px;
    outline: none;
  }
