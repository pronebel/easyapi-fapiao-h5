    ...
    <mt-tab-container v-model="selected">
      <mt-tab-container-item id="1">
          ...
          <form action="" id="formBox" ref="invoiceForm" :model="invoiceForm">
            <a class="mint-cell mint-field"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text" style="font-size: 15px;color:#333">抬头类型</span>
                  <!---->
                </div>
                <div class="mint-cell-value">
                  <input type="radio" id="radio-1-1" name="radio-1-set"
                         class="regular-radio big-radio" value="企业"
                         checked
                         v-model="invoiceForm.type" @click="SaveType('企业')"/>
                  <label for="radio-1-1" @click="SaveType('企业')">企业</label>
                  <input type="radio" id="radio-1-2" name="radio-1-set"
                         class="regular-radio big-radio"
                         v-model="invoiceForm.type" value="个人" @click="SaveType('个人')"/>
                  <label for="radio-1-2" @click="SaveType('个人')">个人</label>
                </div> <!----></div>
            </a>
            <a class="mint-cell mint-field" @click="toAddressManage" v-if="invoiceForm.type==='企业'"><!---->
              <div class="mint-cell-left"></div>
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text" style="font-size: 15px;color:#333">发票抬头</span>
                  <!----></div>
                <div class="mint-cell-value">
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  ...
                  style="vertical-align: inherit;font-size: 15px;color:#333">税号</font></font></span>
                  <!----></div>
                <div class="mint-cell-value">
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  style="vertical-align: inherit;"><font
                  style="vertical-align: inherit;font-size: 15px;color:#333">地址</font></font></span>
                  <!----></div>
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  style="vertical-align: inherit;"><font
                  style="vertical-align: inherit;font-size: 15px;color:#333">电话</font></font></span>
                  <!----></div>
                <div class="mint-cell-value" style="display: block">
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  style="vertical-align: inherit;"><font
                  style="vertical-align: inherit;font-size: 15px;color:#333">开户行</font></font></span>
                  <!----></div>
                <div class="mint-cell-value">
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  style="vertical-align: inherit;"><font
                  style="vertical-align: inherit;font-size: 15px;color:#333">开户行账号</font></font></span>
                  <!----></div>
                <div class="mint-cell-value">
            ...
            <a class="mint-cell mint-field" v-if="invoiceForm.type==='企业' && make==='false'"><!---->
              ...
              <div class="mint-cell-wrapper">
                <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                  style="vertical-align: inherit;"><font
                  style="vertical-align: inherit;">发票内容</font></font></span>
                  <!----></div>
                <div class="mint-cell-value">
        ...
        <div class="invoice-contents" v-if="make==='true'">
          ...
          <ul class="contents-content" v-for="(content,index) in preservationDetails" :key="index">
            ...
            <li style="color: #56cbf6" @click="deleteContent(content.invoiceProductId)">删除</li>
          </ul>
          <div class="btn">
            <mt-button class="submit-btn" @click="addContent"> +添加发票内容</mt-button>
          </div>
          <a class="mint-cell mint-field" style=" border-bottom: 1px solid#ddd;"><!---->
            ...
            <div class="mint-cell-wrapper">
              <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                style="vertical-align: inherit;"><font
                style="vertical-align: inherit;">发票金额</font></font></span>
                <!----></div>
              <div class="mint-cell-value">
          ...
          <a class="mint-cell mint-field"><!---->
            ...
            <div class="mint-cell-wrapper">
              <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                style="vertical-align: inherit;"><font
                style="vertical-align: inherit;">备注</font></font></span>
                <!----></div>
              <div class="mint-cell-value">
                <input :placeholder="remark" type="text" style="font-size: 15px" class="mint-field-core"
        ...
        <div class="page-part">
          ...
          <a class="mint-cell mint-field"><!---->
            ...
            <div class="mint-cell-wrapper">
              <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                style="vertical-align: inherit;"><font
                style="vertical-align: inherit;color:#333;font-size: 15px">电子邮件</font></font></span>
                <!----></div>
              <div class="mint-cell-value">
                <input placeholder="" type="email" class="mint-field-core"
          ...
          <a class="mint-cell mint-field"><!---->
            ...
            <div class="mint-cell-wrapper">
              <div class="mint-cell-title"><!----> <span class="mint-cell-text"><font
                style="vertical-align: inherit;"><font
                style="vertical-align: inherit; color:#333;font-size: 15px">联系方式</font></font></span>
                <!----></div>
              <div class="mint-cell-value"><input placeholder="" type="tal" class="mint-field-core"
                                                  style="color:#333;font-size: 15px"
        ...
        this.$ajax(
          {
            ...
            params: {
              ...
              productPrices: this.priceSplicing.substring(0, this.priceSplicing.length - 1),
              accessToken: this.accessToken,
