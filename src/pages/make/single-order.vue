          ...
          <a class="mint-cell mint-field" style=" border-bottom: 1px solid#ddd;"><!---->
            ...
            <div class="mint-cell-wrapper">
              ...
              <div class="mint-cell-value">
                ...
                <span style="color:#ff4848 ">{{amountOfMoney}} <span
    ...
    methods: {
      ...
      getInvoiceItemList() {
        ...
        this.$ajax.get("/api/item/" + outOrderNo, {
          ...
          if (res.data.code == 1) {
            this.$router.push({path: "/invoice/detail", query: {id: this.scanContent.invoiceId}});
          }
      ...
      goInvoiceSuccess() {
        ...
        this.invoiceForm.category = '增值税电子普通发票';
        this.invoiceForm.property = '电子';
        this.invoiceForm.itemIds = this.contentId.substring(0, this.contentId.length - 1);
        this.$ajax(
          {
            method: 'POST',
            url: '/invoice/apply',
      ...
      calculatedAmount() {
        ...
        if (this.invoiceItemList !== null) {
          for (var i = 0; i < this.invoiceItemList.length; i++) {
            money += this.invoiceItemList[i].price * this.invoiceItemList[i].number
          }
