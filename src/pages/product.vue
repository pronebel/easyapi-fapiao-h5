        ...
        <li>
          ...
          <span>
            <select v-model="tradeName" @change="choice" class="Drop-down-box">
                <option v-for="(item,index) in productList" :value="item.invoiceProductId">{{ item.name }} {{item.specification}}</option>
            </select>
          </span>
        </li>
        <li>
          ...
          <span class="classification-input">
               <input type="text" disabled v-model="specifications" placeholder="规格类型" class="mint-field-core">
          </span>
        </li>
        <li>
          <span class="classification-name">单位</span>
          <span class="classification-input">
            <input type="text" disabled v-model="company" placeholder="单位" class="mint-field-core">
          </span>
        </li>
        <li>
          <span class="classification-name">数量</span>
          <span class="classification-input">
            <input placeholder="需要手动输入数量" v-model="amount" type="tel" class="mint-field-core">
          </span>
        </li>
        <li>
          <span class="classification-name">单价</span>
          <span class="classification-input">
            <input type='number' step="0.01" v-model="unitPrice" placeholder="可输入" style="color:#ff4848;" class="mint-field-core">
          </span>
        </li>
      </ul>
      <div class="btn">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.superposition = JSON.parse(localStorage.getItem("preservationDetails"));
    },
    activated() {
